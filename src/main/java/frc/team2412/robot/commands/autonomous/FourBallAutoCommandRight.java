    ...
    public FourBallAutoCommandRight(IndexSubsystem indexSubsystem, ShooterSubsystem shooterSubsystem,
        ...
        addCommands(
                ...
                new ParallelDeadlineGroup(new WaitCommand(3),
                        new Follow2910TrajectoryCommand(drivebaseSubsystem, driveBack),
                        new IntakeInCommand(indexSubsystem, intakeSubsystem)),
                new ParallelDeadlineGroup(new WaitCommand(4),
                        new Follow2910TrajectoryCommand(drivebaseSubsystem, driveToTerminal),
                        new IntakeInCommand(indexSubsystem, intakeSubsystem)),
                new ParallelCommandGroup(new Follow2910TrajectoryCommand(drivebaseSubsystem, driveToHub),
                        new IntakeInCommand(indexSubsystem, intakeSubsystem)));
    }
}
