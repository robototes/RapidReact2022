...
public class ShooterSubsystem extends SubsystemBase implements Loggable {
  ...
  private void configMotors() {
    ...
    hoodMotor.setSoftLimit(
        CANSparkMax.SoftLimitDirection.kForward, (float) (MAX_HOOD_ANGLE / HOOD_REVS_TO_DEGREES));
    hoodMotor.setSoftLimit(
        CANSparkMax.SoftLimitDirection.kReverse, 0); // Current hood setup plan starts hood at 0,
   ...
   *
   * <p>If angle is too far in one direction but can be reached by rotating in the other direction,
   * the turret will turn in that direction.
   *
