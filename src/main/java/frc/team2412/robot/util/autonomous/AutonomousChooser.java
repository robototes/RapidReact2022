...
public class AutonomousChooser {
    ...
    public enum AutonomousMode {
        ...
        JACK_FOUR_BALL_STEAL(
                (subsystems) -> new JackStealFourBallAutoCommand(subsystems.drivebaseSubsystem, subsystems.intakeSubsystem,
                        subsystems.indexSubsystem,
                        subsystems.shooterSubsystem, subsystems.targetLocalizer),
        ...
        JACK_THREE_BALL_COMPAT_STEAL(
                (subsystems) -> new JackStealThreeBallCompatAutoCommand(subsystems.drivebaseSubsystem, subsystems.intakeSubsystem,
                        subsystems.indexSubsystem,
                        subsystems.shooterSubsystem, subsystems.targetLocalizer),
