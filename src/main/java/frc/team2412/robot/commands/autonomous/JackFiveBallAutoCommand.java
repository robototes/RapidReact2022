...
public class JackFiveBallAutoCommand extends DynamicRequirementSequentialCommandGroup
    ...
    public static class FiveBallConstants {
        public static final TrajectoryConstraint[] NORMAL_SPEED = {
            new FeedforwardConstraint(
                    ...
                    DrivebaseSubsystem.DriveConstants.FEEDFORWARD_CONSTANTS
        ...
        public static final Trajectory PATH_1 =
                new Trajectory(
                        new SimplePathBuilder(new Vector2(328, 75.551), Rotation2.fromDegrees(-90))
                                .arcTo(
                                        new Vector2(293.811, 25.771),
                                        new Vector2(281.299, 92.401),
        ...
        public static final Trajectory PATH_2 =
                new Trajectory(
                        new SimplePathBuilder(
                                        new Vector2(213.203, 66.492), Rotation2.fromDegrees(130))
                                .lineTo(new Vector2(195.049, 82.693), Rotation2.fromDegrees(125))
                                .build(),
                        FAST_SPEED,
                        0.1);

        public static final Trajectory PATH_3 =
                new Trajectory(
                        new SimplePathBuilder(
                                        new Vector2(195.029, 75.188), Rotation2.fromDegrees(125))
                                .lineTo(new Vector2(50.456, 75), Rotation2.fromDegrees(202))
                                .build(),
                        NORMAL_SPEED,
                        0.1);

        public static final Trajectory PATH_4 =
                new Trajectory(
    ...
    public JackFiveBallAutoCommand(
        ...
        ShooterTargetCommand.TurretManager manager =
                new ShooterTargetCommand.TurretManager(shooterSubsystem, localizer);
        ...
        addCommands2(
                ...
                new ParallelCommandGroup(
                        manager.disableAt(0), new IntakeSetStopCommand(intakeSubsystem)));
    }
}
