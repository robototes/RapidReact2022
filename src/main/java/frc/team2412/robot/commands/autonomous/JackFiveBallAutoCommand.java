...
public class JackFiveBallAutoCommand extends DynamicRequirementSequentialCommandGroup
  ...
  public static class FiveBallConstants {
    public static final TrajectoryConstraint[] NORMAL_SPEED = {
      new FeedforwardConstraint(
          ...
          DrivebaseSubsystem.DriveConstants.FEEDFORWARD_CONSTANTS.getAccelerationConstant(),
          false), // old
      // value
      // was
      // 11.0
  ...
  public JackFiveBallAutoCommand(
    ...
    addCommands2(
        ...
        manager.enableAt(70),
        new IndexShootCommand(indexSubsystem).withTimeout(2),
        new ParallelCommandGroup(manager.disableAt(0), new IntakeSetStopCommand(intakeSubsystem)));
  }
}
