...
public class Hardware {
  ...
  public static final int DRIVETRAIN_FRONT_LEFT_DRIVE_MOTOR = 1,
      DRIVETRAIN_FRONT_RIGHT_DRIVE_MOTOR = 4,
      DRIVETRAIN_BACK_LEFT_DRIVE_MOTOR = 7,
      DRIVETRAIN_BACK_RIGHT_DRIVE_MOTOR = 10;
  public static final int DRIVETRAIN_FRONT_LEFT_ANGLE_MOTOR = 2,
      DRIVETRAIN_FRONT_RIGHT_ANGLE_MOTOR = 5,
      DRIVETRAIN_BACK_LEFT_ANGLE_MOTOR = 8,
      DRIVETRAIN_BACK_RIGHT_ANGLE_MOTOR = 11;
  public static final int DRIVETRAIN_FRONT_LEFT_ENCODER_PORT = 3,
      DRIVETRAIN_FRONT_RIGHT_ENCODER_PORT = 6,
      DRIVETRAIN_BACK_LEFT_ENCODER_PORT = 9,
      DRIVETRAIN_BACK_RIGHT_ENCODER_PORT = 12;
  ...
  public static final Mk4Configuration FRONT_LEFT_CONFIG =
      new Mk4Configuration(
          GEAR_RATIO,
  ...
  public static final Mk4Configuration FRONT_RIGHT_CONFIG =
      new Mk4Configuration(
          GEAR_RATIO,
          ...
          DRIVETRAIN_INTAKE_CAN_BUS_NAME);
  public static final Mk4Configuration BACK_LEFT_CONFIG =
      new Mk4Configuration(
          GEAR_RATIO,
          ...
          DRIVETRAIN_INTAKE_CAN_BUS_NAME);
  public static final Mk4Configuration BACK_RIGHT_CONFIG =
      new Mk4Configuration(
          GEAR_RATIO,
  ...
  public static final double MODULE_MAX_VELOCITY_METERS_PER_SEC =
      FRONT_LEFT_CONFIG.getRatio().getConfiguration().getWheelDiameter()
          * Math.PI
          * FRONT_LEFT_CONFIG.getRatio().getConfiguration().getDriveReduction()
          * MODULE_MAX_RPM
          / 60.0;
  ...
  public static final int INTAKE_MOTOR_OUTER = 30,
      INTAKE_MOTOR_INNER = 31,
      INTAKE_SOLENOID_UP = 1,
      INTAKE_SOLENOID_DOWN = 0;

  // index can ids are range 40-49
  public static final int INDEX_INGEST_MOTOR = 40,
      INDEX_FEEDER_MOTOR = 41,
      INGEST_PROXIMITY = 1,
      LEFT_FEEDER_PROXIMITY = 0,
      RIGHT_FEEDER_PROXIMITY = 2;
