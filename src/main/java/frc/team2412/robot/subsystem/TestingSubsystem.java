...
public class TestingSubsystem extends SubsystemBase {
    ...
    /**
     * This testing subsystem is intend for testing new hardware, and should not exist on the final robot
    ...
    public TestingSubsystem() {
        ...
        /*
         * The testing subsystem have its built-in Hardware class, that no need to initialize and store the
         * Hardware in somewhere else
         */
    }
    ...
    public void periodic() {
        /*
         * to measure how long does the ColorSensorV3 take to measure once remember only send to value to
         * telemetry outside the time-evaluation block
         */
